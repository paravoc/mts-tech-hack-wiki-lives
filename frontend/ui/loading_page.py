    ...
    return dedent(
        ...
        <div class="account-switcher" id="accountSwitcher">
          ...
          <div class="account-switcher__menu" id="accountMenu">
            ...
            <button class="account-switcher__item" data-account-user="anton" type="button">
              <span class="account-switcher__item-avatar" style="background:#ffc83d">А</span>
              <span class="account-switcher__item-text">
                <strong>Антон Серганов</strong>
                <span>@anton</span>
              </span>
            </button>

            <button class="account-switcher__item" data-account-user="daria" type="button">
              <span class="account-switcher__item-avatar" style="background:#4f83ff">Д</span>
              <span class="account-switcher__item-text">
                <strong>Дарья Смирнова</strong>
                <span>@daria</span>
              </span>
            </button>

            <button class="account-switcher__item" data-account-user="maxim" type="button">
              <span class="account-switcher__item-avatar" style="background:#5f79ff">М</span>
              <span class="account-switcher__item-text">
                <strong>Максим Карпов</strong>
                <span>@maxim</span>
              </span>
            </button>
