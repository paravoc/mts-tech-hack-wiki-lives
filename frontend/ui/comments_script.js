...
const commentUsers = [
  { id: "ivan", name: "РРІР°РЅ РРІР°РЅРѕРІ", handle: "ivan", short: "Р", color: "#59c4ff", nick: "@ivan", role: "Р РµРґР°РєС‚РѕСЂ Р·РЅР°РЅРёР№", team: "Wiki editors" },
  { id: "sergei", name: "РЎРµСЂРіРµР№ РРІР°РЅРѕРІ", handle: "sergei", short: "РЎ", color: "#7b68ee", nick: "@sergei", role: "Backend", team: "Platform" },
  { id: "anna", name: "РђРЅРЅР° РРІР»РµРІР°", handle: "anna", short: "Рђ", color: "#4f83ff", nick: "@anna", role: "Р”РёР·Р°Р№РЅРµСЂ", team: "Design system" },
  { id: "anton", name: "РђРЅС‚РѕРЅ РЎРµСЂРіР°РЅРѕРІ", handle: "anton", short: "Рђ", color: "#ffc83d", nick: "@anton", role: "Р РµР»РёР·-РјРµРЅРµРґР¶РµСЂ", team: "Release" },
  { id: "maxim", name: "РњР°РєСЃРёРј РљР°СЂРїРѕРІ", handle: "maxim", short: "Рњ", color: "#5f79ff", nick: "@maxim", role: "Frontend", team: "Editor" },
  { id: "maria", name: "РњР°СЂРёСЏ Р’РѕР»РєРѕРІР°", handle: "maria", short: "Рњ", color: "#39c785", nick: "@maria", role: "РђРЅР°Р»РёС‚РёРє", team: "Data ops" }
];
const commentUserMap = new Map(commentUsers.map((user) => [user.id, user]));
const commentGroups = [
  { id: "group-release", name: "РљРѕРјР°РЅРґР° СЂРµР»РёР·Р°", handle: "release", short: "RL", color: "#8b7cff", meta: "Р РµР»РёР·, QA, РІР»Р°РґРµР»СЊС†С‹ Р·Р°РїСѓСЃРєР°" },
  { id: "group-design", name: "Р”РёР·Р°Р№РЅ-СЂРµРІСЊСЋ", handle: "design", short: "DS", color: "#ac8dff", meta: "UX, UI Рё РєРѕРЅС‚РµРЅС‚" },
  { id: "group-backend", name: "Backend core", handle: "backend", short: "BE", color: "#6958f2", meta: "API, РёРЅС‚РµРіСЂР°С†РёРё, storage" },
  { id: "group-wiki", name: "Wiki editors", handle: "wiki", short: "WK", color: "#9a7dff", meta: "Р РµРґР°РєС‚РѕСЂС‹ Рё knowledge owners" }
];
const commentGroupMap = new Map(commentGroups.map((group) => [group.id, group]));

const authStorageKey = "wikilive-auth-user";
let authUser = null;
...
function applyAuthUser(user) {
  ...
  saveAuthUser(user);
  setCurrentCommentActor(user.id || "viewer", false);
...
function ensureAuthOverlay() {
  ...
  authOverlay.innerHTML = `
    <div class="auth-card">
      <h2>Р’С…РѕРґ</h2>
      <p>Р’РІРµРґРёС‚Рµ РїРѕС‡С‚Сѓ РёР· СЃРїСЂР°РІРѕС‡РЅРёРєР° WikiLive.</p>
      <input type="email" id="authEmail" placeholder="РџРѕС‡С‚Р°" />
      <input type="password" id="authPassword" placeholder="РџР°СЂРѕР»СЊ" />
      <div class="auth-error" id="authError"></div>
      <button type="button" id="authSubmit">Р’РѕР№С‚Рё</button>
    </div>
  `;
  document.body.appendChild(authOverlay);
  const authEmail = authOverlay.querySelector("#authEmail");
  const authPassword = authOverlay.querySelector("#authPassword");
  const authError = authOverlay.querySelector("#authError");
  const authSubmit = authOverlay.querySelector("#authSubmit");
  authSubmit.addEventListener("click", async () => {
    const email = (authEmail.value || "").trim();
    const password = authPassword.value || "";
    if (!email || !password) {
      authError.textContent = "Р’РІРµРґРёС‚Рµ РїРѕС‡С‚Сѓ Рё РїР°СЂРѕР»СЊ.";
      return;
    }
    authError.textContent = "";
    try {
      const response = await commentApiRequest("/api/auth/login", {
        method: "POST",
      ...
      if (response && response.user) {
        ...
        authError.textContent = "РќРµРІРµСЂРЅР°СЏ РїРѕС‡С‚Р° РёР»Рё РїР°СЂРѕР»СЊ.";
      }
    } catch (error) {
      authError.textContent = "РќРµ СѓРґР°Р»РѕСЃСЊ РІРѕР№С‚Рё. РџСЂРѕРІРµСЂСЊС‚Рµ СЃРµСЂРІРµСЂ.";
...
const commentsDemoParagraphs = [
  "РџРѕСЂРѕР№ РєР°Р¶РµС‚СЃСЏ, С‡С‚Рѕ РЅР°С€Р° Р¶РёР·РЅСЊ вЂ” СЌС‚Рѕ Р±РµСЃРєРѕРЅРµС‡РЅРѕРµ РїР»Р°РІР°РЅРёРµ РїСЂРѕС‚РёРІ С‚РµС‡РµРЅРёСЏ, РІ РјСѓС‚РЅРѕР№ РІРѕРґРµ РїРѕРІСЃРµРґРЅРµРІРЅС‹С… Р·Р°Р±РѕС‚. РњС‹, РєР°Рє СѓРїСЂСЏРјС‹Рµ Р»РѕСЃРѕСЃРё, СЃС‚СЂРµРјРёРјСЃСЏ Рє СЃРІРѕРёРј С†РµР»СЏРј, РїСЂРµРѕРґРѕР»РµРІР°СЏ РїРѕСЂРѕРіРё С‚СЂСѓРґРЅРѕСЃС‚РµР№ Рё РѕР±С…РѕРґСЏ СЃРµС‚Рё СЃРѕРјРЅРµРЅРёР№. Р РІ СЌС‚РѕР№ РІРµС‡РЅРѕР№ СЃСѓРµС‚Рµ С‚Р°Рє Р»РµРіРєРѕ Р·Р°Р±С‹С‚СЊ, С‡С‚Рѕ СЃР°РјРѕРµ РіР»Р°РІРЅРѕРµ вЂ” РЅРµ РїСЂРѕСЃС‚Рѕ РїР»С‹С‚СЊ РїРѕ С‚РµС‡РµРЅРёСЋ, Р° РЅР°Р№С‚Рё СЃРІРѕСЋ СЃРѕР±СЃС‚РІРµРЅРЅСѓСЋ, СѓРЅРёРєР°Р»СЊРЅСѓСЋ РіР»СѓР±РёРЅРЅСѓСЋ СЃС‚СЂСѓСЋ, РєРѕС‚РѕСЂР°СЏ РІС‹РІРµРґРµС‚ Рє С‡РёСЃС‚РѕР№ РІРѕРґРµ Рё РїСЂРѕСЃС‚РѕСЂСѓ РЅР°СЃС‚РѕСЏС‰РёС… РґРѕСЃС‚РёР¶РµРЅРёР№.",
  "РќРѕ СЃС‚РѕРёС‚ Р»РёС€СЊ РЅР° РјРіРЅРѕРІРµРЅРёРµ РѕСЃС‚Р°РЅРѕРІРёС‚СЊСЃСЏ Рё РїСЂРёСЃР»СѓС€Р°С‚СЊСЃСЏ Рє С‚РёС…РѕРјСѓ РїР»РµСЃРєСѓ РјС‹СЃР»РµР№, РєР°Рє СЃС‚Р°РЅРѕРІРёС‚СЃСЏ СЏСЃРЅРѕ: РєР°Р¶РґС‹Р№ РёР· РЅР°СЃ вЂ” СЌС‚Рѕ С†РµР»С‹Р№ РѕРєРµР°РЅ РІРѕР·РјРѕР¶РЅРѕСЃС‚РµР№. РќР°С€Рµ СЃРѕР·РЅР°РЅРёРµ вЂ” РЅРµ РјРµР»РєРёР№ РїСЂСѓРґ, Р° Р±РµР·РґРѕРЅРЅС‹Р№ РјРѕСЂСЃРєРѕР№ С€РµР»СЊС„, РіРґРµ С‚Р°СЏС‚СЃСЏ РЅРµРёСЃСЃР»РµРґРѕРІР°РЅРЅС‹Рµ РєРѕСЂР°Р»Р»РѕРІС‹Рµ СЂРёС„С‹ РёРґРµР№ Рё Р¶РµРјС‡СѓР¶РёРЅС‹ РѕР·Р°СЂРµРЅРёР№. РџРѕСЂРѕР№ РЅСѓР¶РЅРѕ РїСЂРѕСЃС‚Рѕ РґР°С‚СЊ СЃРµР±Рµ СЃРІРѕР±РѕРґСѓ РЅС‹СЂРЅСѓС‚СЊ РІ СЌС‚Сѓ РїСѓС‡РёРЅСѓ, С‡С‚РѕР±С‹ РѕР±РЅР°СЂСѓР¶РёС‚СЊ СЃРѕРєСЂРѕРІРёС‰Р°, Рѕ РєРѕС‚РѕСЂС‹С… РјС‹ Рё РЅРµ РїРѕРґРѕР·СЂРµРІР°Р»Рё, РіР»СЏРґСЏ Р»РёС€СЊ РЅР° СЂСЏР±СЊ РЅР° РїРѕРІРµСЂС…РЅРѕСЃС‚Рё.",
  "Р РїРѕС‚РѕРјСѓ, РѕРєР°Р·Р°РІС€РёСЃСЊ РІ РІРѕРґРѕРІРѕСЂРѕС‚Рµ СЃРѕР±С‹С‚РёР№, РЅРµ РїРѕР·РІРѕР»СЏР№ СЃРµР±Рµ РѕРїСѓСЃРєР°С‚СЊСЃСЏ РЅР° РґРЅРѕ. Р Р°СЃРїСЂР°РІСЊ РїР°СЂСѓСЃР° СЃРІРѕРµР№ РјРµС‡С‚С‹ Рё Р»РѕРІРё РїРѕРїСѓС‚РЅС‹Р№ РІРµС‚РµСЂ РїРµСЂРµРјРµРЅ. РџРѕРјРЅРё, С‡С‚Рѕ РґР°Р¶Рµ СЃР°РјР°СЏ РєСЂСѓРїРЅР°СЏ СЂС‹Р±Р° РєРѕРіРґР°-С‚Рѕ Р±С‹Р»Р° РјР°Р»СЊРєРѕРј, Р° РІРµР»РёРєРёРµ РѕС‚РєСЂС‹С‚РёСЏ С‡Р°СЃС‚Рѕ СЂРѕР¶РґР°СЋС‚СЃСЏ РЅРµ РІ С€С‚РёР»СЊ, Р° РІ СЃР°РјСѓСЋ Р±СѓСЂСЋ. Р”РѕРІРµСЂСЏР№ СЃРІРѕРµРјСѓ РІРЅСѓС‚СЂРµРЅРЅРµРјСѓ РєРѕРјРїР°СЃСѓ, Рё С‚С‹ РѕР±СЏР·Р°С‚РµР»СЊРЅРѕ РЅР°Р№РґРµС€СЊ С‚Сѓ СЃР°РјСѓСЋ Р±СѓС…С‚Сѓ, РіРґРµ РјРѕСЂРµ СЃРїРѕРєРѕР№РЅРѕ, Р° СѓР»РѕРІ Р±РѕРіР°С‚."
];
...
const historySeed = [
  {
    id: "hist-1",
    userId: "ivan",
    date: "27.10.25 РІ 18:03",
    statusText: "РЈРґР°Р»РµРЅР° 29.10.25 РІ 13:32",
    preview: "РќРѕ СЃС‚РѕРёС‚ Р»РёС€СЊ РЅР° РјРіРЅРѕРІРµРЅРёРµ РѕСЃС‚Р°РЅРѕРІРёС‚СЊСЃСЏ Рё РїСЂРёСЃР»СѓС€Р°С‚СЊСЃСЏ Рє С‚РёС…РѕРјСѓ РїР»РµСЃРєСѓ РјС‹СЃР»РµР№, РєР°Рє СЃС‚Р°...",
    text: "Р”СѓРјР°СЋ СЌС‚РѕС‚ РїР°СЂР°РіСЂР°С„ СЃС‚РѕРёС‚ РїРµСЂРµРїРёСЃР°С‚СЊ, СЃР»РёС€РєРѕРј СЃР»РѕР¶РЅРѕ, С‚СѓС‚ Р¶Рµ РІРµСЃСЊ СЃРјС‹СЃР» РІ РїСЂРѕСЃС‚РѕС‚Рµ РґРѕРЅРµСЃРµРЅРёСЏ РјС‹СЃР»Рё. Р§РёС‚Р°С‚РµР»СЊ РЅРµ РїРѕР№РјРµС‚, РµСЃР»Рё РјС‹ Р±СѓРґРµС‚ РіРѕРІРѕСЂРёС‚СЊ РєР°Рє Р”РѕСЃС‚РѕРµРІСЃРєРёР№, РЅСѓР¶РЅРѕ РєР°Рє Р¤РµР№СЃ",
    toggleLabel: "РџРѕРєР°Р·Р°С‚СЊ 20 РєРѕРјРјРµРЅС‚Р°СЂРёРµРІ РІРµС‚РєРё",
    thread: [
      { userId: "ivan", date: "27.10.25 РІ 18:03", text: "Р­С‚РѕС‚ С‚РµРєСЃС‚ С‚СЏР¶РµР»Рѕ РІРѕСЃРїСЂРёРЅРёРјР°С‚СЊ. Р”Р°РІР°Р№С‚Рµ СЃРґРµР»Р°РµРј РµРіРѕ РїСЂРѕС‰Рµ Рё РїРѕРЅСЏС‚РЅРµРµ РґР»СЏ С‡РёС‚Р°С‚РµР»СЏ." },
      { userId: "ivan", date: "27.10.25 РІ 18:03", text: "РЎР»РёС€РєРѕРј СЃР»РѕР¶РЅРѕ РЅР°РїРёСЃР°РЅРѕ. РќСѓР¶РЅРѕ, С‡С‚РѕР±С‹ С‡РёС‚Р°С‚РµР»СЊ РїРѕРЅРёРјР°Р» РІСЃРµ СЃ РїРµСЂРІРѕРіРѕ СЂР°Р·Р°, РєР°Рє Р±СѓРґС‚Рѕ СЃ РґСЂСѓРіРѕРј РіРѕРІРѕСЂРёС€СЊ." }
    ]
  },
  {
    id: "hist-2",
    userId: "sergei",
    date: "27.10.25 РІ 18:03",
    statusText: "Р РµС€РµРЅР° 29.10.25 РІ 13:32",
    preview: "РџРѕСЂРѕР№ РєР°Р¶РµС‚СЃСЏ, С‡С‚Рѕ РЅР°С€Р° Р¶РёР·РЅСЊ вЂ” СЌС‚Рѕ Р±РµСЃРєРѕРЅРµС‡РЅРѕРµ РїР»Р°РІР°РЅРёРµ РІ РјСѓС‚РЅРѕР№ РІРѕРґРµ РїРѕРІСЃРµРґРЅРµРІРЅС‹С…...",
    text: "РњРѕРµ РїСЂРµРґР»РѕР¶РµРЅРёРµ РІРѕРѕР±С‰Рµ РЅРёС‡РµРіРѕ РЅРµ РґРµР»Р°С‚СЊ. РџРѕС‚РѕРјСѓ С‡С‚Рѕ Р»РµРЅСЊ.",
    toggleLabel: "РџРѕРєР°Р·Р°С‚СЊ 2 РєРѕРјРјРµРЅС‚Р°СЂРёСЏ РІРµС‚РєРё",
    thread: [
      { userId: "ivan", date: "27.10.25 РІ 18:03", text: "Р­С‚РѕС‚ С‚РµРєСЃС‚ С‚СЏР¶РµР»Рѕ РІРѕСЃРїСЂРёРЅРёРјР°С‚СЊ. Р”Р°РІР°Р№С‚Рµ СЃРґРµР»Р°РµРј РµРіРѕ РїСЂРѕС‰Рµ Рё РїРѕРЅСЏС‚РЅРµРµ РґР»СЏ С‡РёС‚Р°С‚РµР»СЏ." },
      { userId: "ivan", date: "27.10.25 РІ 18:03", text: "РЎР»РёС€РєРѕРј СЃР»РѕР¶РЅРѕ РЅР°РїРёСЃР°РЅРѕ. РќСѓР¶РЅРѕ, С‡С‚РѕР±С‹ С‡РёС‚Р°С‚РµР»СЊ РїРѕРЅРёРјР°Р» РІСЃРµ СЃ РїРµСЂРІРѕРіРѕ СЂР°Р·Р°, РєР°Рє Р±СѓРґС‚Рѕ СЃ РґСЂСѓРіРѕРј РіРѕРІРѕСЂРёС€СЊ." }
    ]
  },
  {
    ...
    statusText: "Р РµС€РµРЅР° 29.10.25 РІ 13:32",
    preview: "",
    text: "@sergei Р·Р°РјРµРЅРёС‚СЊ РєР°СЂС‚РёРЅРєСѓ",
    thumb: true,
    likes: 4,
    toggleLabel: "РџРѕРєР°Р·Р°С‚СЊ 1 РєРѕРјРјРµРЅС‚Р°СЂРёР№ РІРµС‚РєРё",
    thread: [
      { userId: "sergei", date: "27.10.25 РІ 18:03", text: "РћРє, Р·Р°РјРµРЅСЋ РЅР° Р±РѕР»РµРµ СЃРїРѕРєРѕР№РЅС‹Р№ РєР°РґСЂ." }
    ]
  }
];
...
function renderPagePresence() {
  ...
  pagePresenceAvatars.innerHTML = people.slice(0, 4).map((person) => `
    <span
      ...
      title="${escapeHtml(person.actorName || person.actorId || "РЈС‡Р°СЃС‚РЅРёРє")}"
...
function renderPagesSwitcher() {
  ...
  if (!ownedPages.length) {
    pagesList.innerHTML = '<div class="pages-switcher__empty">РџРѕРєР° РЅРµС‚ СЃС‚СЂР°РЅРёС†</div>';
    renderPagePresence();
    return;
  }
  ...
  pagesList.innerHTML = ownedPages.map((page) => {
    ...
    const preview = String(page.title || "Р‘РµР· РЅР°Р·РІР°РЅРёСЏ").trim() || "Р‘РµР· РЅР°Р·РІР°РЅРёСЏ";
    ...
    return `
      <button class="pages-switcher__item${isActive ? " is-active" : ""}" data-page-id="${page.pageId}" type="button">
        ...
        <span class="pages-switcher__item-meta">${headingCount ? `${headingCount} Р·Р°РіРѕР»РѕРІРєРѕРІ` : "Р‘РµР· СЂР°Р·РґРµР»РѕРІ"}</span>
      </button>
    `;
  }).join("");
  renderPagePresence();
...
function renderAccountSwitcher() {
  ...
  accountAvatar.textContent = actor.short || "Р“";
...
function renderActorPicker() {
  ...
  const actorOptions = commentUsers.map((user) => {
    ...
    return `<option value="${user.id}"${selected}>${escapeHtml(user.name)} В· ${escapeHtml(user.role)}</option>`;
  });
  if (!commentUsers.some((user) => user.id === currentCommentActorId)) {
    actorOptions.unshift('<option value="viewer" selected>Р“РѕСЃС‚СЊ В· РќР°Р±Р»СЋРґР°С‚РµР»СЊ</option>');
  }
  commentsActorSelect.innerHTML = actorOptions.join("");

  const actor = getCurrentCommentActor();
  if (commentsActorNote) {
    commentsActorNote.textContent = `${actor.team} В· ${actor.nick}`;
  }
...
function buildWikiLiveLinkSections() {
  const currentPage = {
    ...
    title: titleEditor.textContent.replace(/\u200B/g, "").trim() || "РќРѕРІР°СЏ СЃС‚СЂР°РЅРёС†Р°",
    content: content || "",
  ...
  sections.push({
    id: "current-page",
    title: "РўРµРєСѓС‰Р°СЏ СЃС‚СЂР°РЅРёС†Р°",
    open: true,
    items: currentItems,
  });
  ...
  otherPages.forEach((page) => {
    sections.push({
      id: `page-${page.pageId}`,
      title: page.title || "Р‘РµР· РЅР°Р·РІР°РЅРёСЏ",
...
function formatCommentText(text) {
  ...
  return safe.replace(/(^|\s)(@[A-Za-z0-9._\-\u0400-\u04FF]+)/g, (match, prefix, mention) => prefix + '<span class="comment-mention">' + mention + "</span>");
}
...
function getCommentUser(userId) {
  ...
  const label = String(userId || "РџРѕР»СЊР·РѕРІР°С‚РµР»СЊ").trim() || "РџРѕР»СЊР·РѕРІР°С‚РµР»СЊ";
  return {
...
function updateDocumentHeader(page) {
  if (docHeaderTitle) {
    docHeaderTitle.textContent = (page && page.title) || "РќРѕРІР°СЏ СЃС‚СЂР°РЅРёС†Р°";
  }
  if (docHeaderSubtitle) {
    const nextDescription = String(page && page.description ? page.description : "").trim();
    docHeaderSubtitle.textContent = nextDescription || "Р”РѕР±Р°РІРёС‚СЊ РѕРїРёСЃР°РЅРёРµ";
...
function getDocumentDescriptionText() {
  ...
  if (!text || text === "Р”РѕР±Р°РІРёС‚СЊ РѕРїРёСЃР°РЅРёРµ") {
    return "";
  }
  return text;
}
...
function syncDocumentSubtitlePlaceholder(forcePlaceholder = false) {
  ...
  if (shouldPlaceholder) {
    docHeaderSubtitle.textContent = "Р”РѕР±Р°РІРёС‚СЊ РѕРїРёСЃР°РЅРёРµ";
  }
}

async function saveCommentDocumentNow(label = "РР·РјРµРЅРµРЅРёРµ С‚РµРєСЃС‚Р°", author = "editor") {
  ...
  try {
    ...
    const nextSnapshot = buildVersionSnapshot(documentPayload);
    const pendingLabel = commentPendingVersionLabel || label || "РР·РјРµРЅРµРЅРёРµ С‚РµРєСЃС‚Р°";
    documentPayload.versionLabel = isGenericVersionLabel(pendingLabel)
      ? inferDocumentVersionLabel(commentLastSavedSnapshot, nextSnapshot, pendingLabel)
      : pendingLabel;
    ...
    documentPayload.ownerName = getCurrentCommentActor().name || "Р“РѕСЃС‚СЊ";
...
function getThreadTargetLabel(targetType) {
  switch (targetType) {
    ...
    case "data":
      return "Р–РёРІС‹Рµ РґР°РЅРЅС‹Рµ";
    case "paragraph":
    case "p":
      return "РђР±Р·Р°С†";
    default:
      return "Р¤СЂР°РіРјРµРЅС‚";
  }
}

function inferAttachmentForThread(targetType, preview) {
  if (targetType === "image") {
    return { attachmentType: "image", attachmentLabel: preview || "РР·РѕР±СЂР°Р¶РµРЅРёРµ" };
  }
  if (targetType === "file") {
    return { attachmentType: "file", attachmentLabel: preview || "Р¤Р°Р№Р»" };
  }
  if (targetType === "table" || targetType === "data") {
    return { attachmentType: "data", attachmentLabel: preview || "Р–РёРІС‹Рµ РґР°РЅРЅС‹Рµ" };
  }
...
function renderAttachmentPreview(type, label) {
  ...
  if (type === "file") {
    return `<div class="comment-card__attachment comment-card__attachment--file"><span class="comment-card__attachment-icon">в†—</span><span>${escapeHtml(label)}</span></div>`;
  }
...
function getReplyPreview(thread, comment) {
  ...
  return `<div class="comment-card__quote"><div class="comment-card__quote-label">РћС‚РІРµС‚ @${escapeHtml(repliedUser.handle)}</div><div class="comment-card__quote-text">${escapeHtml(replied.text).slice(0, 88)}${replied.text.length > 88 ? "вЂ¦" : ""}</div></div>`;
}
...
function formatThreadDate(isoValue) {
  ...
  return parsed.toLocaleDateString("ru-RU") + " РІ " + parsed.toLocaleTimeString("ru-RU", { hour: "2-digit", minute: "2-digit" });
}

function serializeEditorDocument() {
  const content = typeof window.wikiliveGetSerializableEditorHtml === "function"
    ? window.wikiliveGetSerializableEditorHtml(bodyEditor)
    : bodyEditor.innerHTML;
  return {
    title: titleEditor.textContent.replace(/\u200B/g, "").trim() || "РЎС‚СЂР°РЅРёС†Р° РґР»СЏ РєРѕРјРјРµРЅС‚РёСЂРѕРІР°РЅРёСЏ",
    description: getDocumentDescriptionText(),
    content
  };
}

function normalizeVersionLineText(value) {
  return String(value || "").replace(/\u200B/g, "").replace(/\s+/g, " ").trim();
}

function extractVersionSnapshotFromHtml(title, description, html) {
  const root = document.createElement("div");
  root.innerHTML = html || "";

  if (typeof window.wikiliveCanonicalizeMwsBlocksRoot === "function") {
    window.wikiliveCanonicalizeMwsBlocksRoot(root);
  }

  root.querySelectorAll(".body-placeholder").forEach((node) => node.remove());
  root.querySelectorAll(".mws-live-block").forEach((node) => {
    const label = normalizeVersionLineText(node.textContent || node.getAttribute("data-mws-label") || "MWS");
    node.replaceWith(document.createTextNode(`[MWS] ${label || "MWS"}`));
  });
  root.querySelectorAll(".embedded-image-block").forEach((node) => {
    const image = node.querySelector("img");
    const label = normalizeVersionLineText(
      (image && (image.getAttribute("alt") || image.getAttribute("title"))) ||
      node.getAttribute("data-file-name") ||
      node.textContent ||
      "РР·РѕР±СЂР°Р¶РµРЅРёРµ"
    );
    node.replaceWith(document.createTextNode(`[РР·РѕР±СЂР°Р¶РµРЅРёРµ] ${label || "РР·РѕР±СЂР°Р¶РµРЅРёРµ"}`));
  });
  root.querySelectorAll(".embedded-file-chip").forEach((node) => {
    const label = normalizeVersionLineText(node.textContent || "РћР±СЉРµРєС‚");
    node.replaceWith(document.createTextNode(`[РћР±СЉРµРєС‚] ${label || "РћР±СЉРµРєС‚"}`));
  });
  root.querySelectorAll("[data-live-token], [data-live-value], .live-data-chip, .formula-chip, .table-value-chip").forEach((node) => {
    const label = normalizeVersionLineText(node.textContent || node.getAttribute("data-live-token") || node.getAttribute("data-live-value") || "Р”Р°РЅРЅС‹Рµ");
    node.replaceWith(document.createTextNode(`[Р”Р°РЅРЅС‹Рµ] ${label || "Р”Р°РЅРЅС‹Рµ"}`));
  });
  root.querySelectorAll("table").forEach((node) => {
    ...
    const label = rows || cols ? `[РўР°Р±Р»РёС†Р°] ${rows}x${cols}` : "[РўР°Р±Р»РёС†Р°]";
    node.replaceWith(document.createTextNode(label));
  });

  const rawContentText = normalizeVersionLineText(root.innerText || root.textContent || "");
  const logicalBlockSelector = "p, h1, h2, h3, h4, h5, h6, li, blockquote, pre, tr, .mws-live-block, .embedded-image-block, .embedded-file-chip, .live-data-chip, .formula-chip, .table-value-chip, [data-live-token], [data-live-value], table";
  const contentParagraphs = Array.from(root.querySelectorAll(logicalBlockSelector))
    .filter((node) => !(node.parentElement && node.parentElement.closest(logicalBlockSelector)))
    .map((node) => normalizeVersionLineText(node.innerText || node.textContent || ""))
    .filter(Boolean);
  const contentLines = rawContentText
    ? rawContentText
      .split(/\n+/)
      .map((line) => normalizeVersionLineText(line))
      .filter(Boolean)
    : [];

  return {
    title: normalizeVersionLineText(title),
    description: normalizeVersionLineText(description),
    contentHtml: html || "",
    contentText: rawContentText,
    contentParagraphs,
    contentLines,
    linkCount: root.querySelectorAll("a[href]").length,
    imageCount: (html.match(/embedded-image-block/g) || []).length,
    fileCount: (html.match(/embedded-file-chip/g) || []).length,
    dataCount: root.querySelectorAll(".mws-live-block, [data-live-token], [data-live-value], .live-data-chip, .formula-chip, .table-value-chip, table").length
  };
}

function buildVersionSnapshot(documentPayload = serializeEditorDocument()) {
  if (!documentPayload) {
    return extractVersionSnapshotFromHtml("", "", "");
  }
  return extractVersionSnapshotFromHtml(
...
function computeLineDiff(beforeLines = [], afterLines = []) {
  ...
  return {
    added: afterLines.slice(prefix, afterSuffix + 1),
    removed: beforeLines.slice(prefix, beforeSuffix + 1)
  };
}

function computeParagraphDiff(beforeParagraphs = [], afterParagraphs = []) {
  let prefix = 0;
  while (
    prefix < beforeParagraphs.length &&
    prefix < afterParagraphs.length &&
    beforeParagraphs[prefix] === afterParagraphs[prefix]
  ) {
    prefix += 1;
  }

  let beforeSuffix = beforeParagraphs.length - 1;
  let afterSuffix = afterParagraphs.length - 1;
  while (
    beforeSuffix >= prefix &&
    afterSuffix >= prefix &&
    beforeParagraphs[beforeSuffix] === afterParagraphs[afterSuffix]
  ) {
    beforeSuffix -= 1;
    afterSuffix -= 1;
  }

  const removed = beforeParagraphs.slice(prefix, beforeSuffix + 1);
  const added = afterParagraphs.slice(prefix, afterSuffix + 1);
  const changed = [];
  ...
  return {
    changed,
    added: added.slice(pairCount),
    removed: removed.slice(pairCount)
  };
}

function isGenericVersionLabel(label) {
  const normalized = normalizeVersionLineText(label).toLowerCase();
  return [
    "",
    "РёР·РјРµРЅРµРЅРёРµ С‚РµРєСЃС‚Р°",
    "РёР·РјРµРЅРµРЅ С‚РµРєСЃС‚",
    "РґРѕР±Р°РІР»РµРЅ С‚РµРєСЃС‚",
    "СѓРґР°Р»РµРЅ С‚РµРєСЃС‚",
    "РёР·РјРµРЅРµРЅ Р·Р°РіРѕР»РѕРІРѕРє",
    "РёР·РјРµРЅРµРЅРѕ РЅР°Р·РІР°РЅРёРµ СЃС‚СЂР°РЅРёС†С‹",
    "РёР·РјРµРЅРµРЅРѕ РѕРїРёСЃР°РЅРёРµ"
  ].includes(normalized);
}

function inferDocumentVersionLabel(previousSnapshot, nextSnapshot, fallbackLabel = "РР·РјРµРЅРµРЅРёРµ С‚РµРєСЃС‚Р°") {
  if (!nextSnapshot || !previousSnapshot) {
    return fallbackLabel || "РР·РјРµРЅРµРЅРёРµ С‚РµРєСЃС‚Р°";
  }
  ...
  const contentChanged = previousSnapshot.contentHtml !== nextSnapshot.contentHtml;
  const linkDelta = nextSnapshot.linkCount - previousSnapshot.linkCount;
  const imageDelta = nextSnapshot.imageCount - previousSnapshot.imageCount;
  const fileDelta = nextSnapshot.fileCount - previousSnapshot.fileCount;
  const dataDelta = nextSnapshot.dataCount - previousSnapshot.dataCount;
  const diff = computeLineDiff(previousSnapshot.contentLines, nextSnapshot.contentLines);

  if (titleChanged && !descriptionChanged && !contentChanged) {
    return "РР·РјРµРЅРµРЅРѕ РЅР°Р·РІР°РЅРёРµ СЃС‚СЂР°РЅРёС†С‹";
  }
  if (!titleChanged && descriptionChanged && !contentChanged) {
    return "РР·РјРµРЅРµРЅРѕ РѕРїРёСЃР°РЅРёРµ";
  }
  if (imageDelta > 0) {
    return "Р’СЃС‚Р°РІРєР° РёР·РѕР±СЂР°Р¶РµРЅРёСЏ";
  }
  if (fileDelta > 0) {
    return "Р’СЃС‚Р°РІРєР° РѕР±СЉРµРєС‚Р°";
  }
  if (dataDelta > 0) {
    return "Р’СЃС‚Р°РІРєР° РґР°РЅРЅС‹С… РёР· С‚Р°Р±Р»РёС†С‹";
  }
  if (linkDelta > 0) {
    return "РЎРѕР·РґР°РЅР° СЃСЃС‹Р»РєР°";
  }
  if (contentChanged) {
    if (diff.added.length && !diff.removed.length) {
      return "Р”РѕР±Р°РІР»РµРЅ С‚РµРєСЃС‚";
    }
    if (diff.removed.length && !diff.added.length) {
      return "РЈРґР°Р»РµРЅ С‚РµРєСЃС‚";
    }
    return "РР·РјРµРЅРµРЅ С‚РµРєСЃС‚";
  }
  if (titleChanged) {
    return "РР·РјРµРЅРµРЅРѕ РЅР°Р·РІР°РЅРёРµ СЃС‚СЂР°РЅРёС†С‹";
  }
...
window.wikiliveBuildVersionSnapshot = buildVersionSnapshot;
window.wikiliveComputeLineDiff = computeLineDiff;
window.wikiliveComputeParagraphDiff = computeParagraphDiff;
window.wikiliveInferDocumentVersionLabel = inferDocumentVersionLabel;
...
function applyEditorDocument(page) {
  ...
  titleEditor.textContent = page.title || "РЎС‚СЂР°РЅРёС†Р° РґР»СЏ РєРѕРјРјРµРЅС‚РёСЂРѕРІР°РЅРёСЏ";
  bodyEditor.innerHTML = page.content && page.content.trim() ? page.content : `<p class="body-placeholder">${emptyHint}</p>`;
  renderOutline();
  commentLastSavedSnapshot = buildVersionSnapshot({
    title: page.title || "",
...
function queueCommentVersionLabel(label, author = "editor") {
  ...
  if (
    !commentPendingVersionLabel ||
    (isGenericVersionLabel(commentPendingVersionLabel) && !isGenericVersionLabel(label)) ||
    (isGenericVersionLabel(commentPendingVersionLabel) === isGenericVersionLabel(label))
  ) {
...
function classifyMutationLabel(mutations) {
  ...
  mutations.forEach((mutation) => {
    ...
    Array.from(mutation.addedNodes || []).forEach((node) => {
      ...
      if (
        node.matches(".mws-live-block, [data-live-token], [data-live-value], .live-data-chip, .formula-chip, .table-value-chip, table") ||
        node.querySelector(".mws-live-block, [data-live-token], [data-live-value], .live-data-chip, .formula-chip, .table-value-chip, table")
      ) {
        sawDataChange = true;
      }
    });
  ...
  if (sawDeletion) {
    return "РЈРґР°Р»РµРЅРёРµ СЃРѕРґРµСЂР¶РёРјРѕРіРѕ";
  }
  return "";
}
...
function scheduleCommentDocumentSave(label = "", author = "editor") {
  ...
  queueCommentVersionLabel(label || "РР·РјРµРЅРµРЅРёРµ С‚РµРєСЃС‚Р°", author);
  if (commentSaveTimer) {
    clearTimeout(commentSaveTimer);
  }
  ...
  [...(activeData.items || []), ...(historyData.items || [])].forEach((item) => {
    ...
    if (!threadMap.has(item.threadId)) {
      threadMap.set(item.threadId, {
        ...
        preview: item.targetPreview || item.selectionLabel || "Р‘РµР· РЅР°Р·РІР°РЅРёСЏ РѕР±СЃСѓР¶РґРµРЅРёСЏ",
        targetType: item.targetType || "",
...
function renderHistoryFilters() {
  ...
  commentsHistoryPageSelect.innerHTML = accessiblePages.map((page) => `
    <option value="${page.pageId}"${page.pageId === selectedPageId ? " selected" : ""}>${escapeHtml(page.title || "Р‘РµР· РЅР°Р·РІР°РЅРёСЏ")}</option>
  `).join("");

  const options = [{ threadId: "", preview: "Р’СЃРµ РѕР±СЃСѓР¶РґРµРЅРёСЏ", status: "all" }, ...commentHistoryThreadOptions];
  commentsHistoryThreadSelect.innerHTML = options.map((thread) => {
    let suffix = "";
    if (thread.status === "paused") {
      suffix = " В· РЅР° РїР°СѓР·Рµ";
    } else if (thread.status === "resolved") {
      suffix = " В· СЂРµС€РµРЅР°";
    } else if (thread.status === "deleted") {
      suffix = " В· СѓРґР°Р»РµРЅР°";
    }
    return `<option value="${thread.threadId}"${thread.threadId === (commentHistorySelectedThreadId || "") ? " selected" : ""}>${escapeHtml((thread.preview || "Р‘РµР· РЅР°Р·РІР°РЅРёСЏ РѕР±СЃСѓР¶РґРµРЅРёСЏ") + suffix)}</option>`;
  }).join("");
}
...
async function ensureCommentPage() {
  ...
  commentBootstrapPromise = (async () => {
    ...
    if (!page) {
      page = items.find((item) => item.title === "РЎС‚СЂР°РЅРёС†Р° РґР»СЏ РєРѕРјРјРµРЅС‚РёСЂРѕРІР°РЅРёСЏ") || null;
    }
    ...
    if (!page) {
      const created = await commentApiRequest("/api/pages", {
        ...
        body: JSON.stringify({
          ...
          versionLabel: "РЎРѕР·РґР°РЅР° СЃС‚СЂР°РЅРёС†Р°",
...
function seedCommentsDemoDocumentIfNeeded() {
  ...
  titleEditor.textContent = "РЎС‚СЂР°РЅРёС†Р° РґР»СЏ РєРѕРјРјРµРЅС‚РёСЂРѕРІР°РЅРёСЏ";
...
function getTargetPreview(target) {
  ...
  if (target.classList.contains("embedded-image-block")) {
    ...
    return img && img.getAttribute("alt") ? "РР·РѕР±СЂР°Р¶РµРЅРёРµ вЂў " + img.getAttribute("alt") : "РР·РѕР±СЂР°Р¶РµРЅРёРµ";
  }
  if (target.classList.contains("embedded-file-chip")) {
    return "Р¤Р°Р№Р» вЂў " + target.textContent.replace(/\s+/g, " ").trim();
  }
  return target.textContent.replace(/\s+/g, " ").trim() || "РџСѓСЃС‚РѕР№ Р±Р»РѕРє";
}
...
async function dissolveDiscussionTarget(targetId, reason = "РР·РјРµРЅРµРЅРёРµ РѕР±СЃСѓР¶РґР°РµРјРѕРіРѕ С„СЂР°РіРјРµРЅС‚Р°") {
  if (!targetId) {
    return;
  }
...
function scheduleOrphanThreadCleanup() {
  ...
  commentCleanupTimer = window.setTimeout(async () => {
    ...
    for (const targetId of orphanIds) {
      await dissolveDiscussionTarget(targetId, "РЈРґР°Р»РµРЅРѕ РѕР±СЃСѓР¶РґР°РµРјРѕРµ СЃРѕРґРµСЂР¶РёРјРѕРµ");
    }
  }, 260);
}
...
async function handleProtectedCommentInput(inputType, data) {
  ...
  const approved = window.confirm("Р­С‚Рѕ РѕР±СЃСѓР¶РґР°РµРјС‹Р№ С„СЂР°РіРјРµРЅС‚. Р Р°Р·РѕСЂРІР°С‚СЊ РѕР±СЃСѓР¶РґРµРЅРёРµ Рё РѕС‚СЂРµРґР°РєС‚РёСЂРѕРІР°С‚СЊ С‚РµРєСЃС‚?");
  if (!approved) {
    return true;
  }
  ...
  await dissolveDiscussionTarget(targetId, "Р Р°Р·РѕСЂРІР°РЅРѕ РѕР±СЃСѓР¶РґРµРЅРёРµ РґР»СЏ СЂРµРґР°РєС‚РёСЂРѕРІР°РЅРёСЏ");
...
function collectHistoryItems(pageItems, page, totalPages) {
  ...
  visiblePages.forEach((entry) => {
    if (entry === "ellipsis") {
      footer.push('<span class="comments-history-modal__ellipsis">вЂ¦</span>');
      return;
    }
  ...
  if (page < totalPages) {
    footer.push('<button class="comments-history-modal__next" data-history-action="next" type="button" aria-label="РЎР»РµРґСѓСЋС‰Р°СЏ СЃС‚СЂР°РЅРёС†Р°">вЂє</button>');
  }
  return footer.join("");
}
...
function seedThreads(targets) {
  ...
  if (targets[0]) {
    ...
    commentThreads.set(id, createThread("thread-main", id, {
      ...
      likedBy: ["ivan", "sergei"],
      comments: [
        createComment("comment-1", "ivan", "27.10.25 РІ 18:03", "Р”СѓРјР°СЋ СЌС‚РѕС‚ РїР°СЂР°РіСЂР°С„ СЃС‚РѕРёС‚ РїРµСЂРµРїРёСЃР°С‚СЊ: С‡РёС‚Р°С‚РµР»СЊ СЃРїРѕС‚С‹РєР°РµС‚СЃСЏ СѓР¶Рµ РІ РїРµСЂРІРѕР№ СЃС‚СЂРѕРєРµ.", { targetPreview: getTargetPreview(targets[0]), targetType }),
        createComment("comment-2", "sergei", "27.10.25 РІ 18:03", "РЇ Р±С‹ СЃРѕРєСЂР°С‚РёР» РµРіРѕ РїРѕС‡С‚Рё РІРґРІРѕРµ Рё РІС‹РЅРµСЃ РґРµС‚Р°Р»Рё РЅРёР¶Рµ РѕС‚РґРµР»СЊРЅС‹Рј Р±Р»РѕРєРѕРј."),
        createComment("comment-3", "anna", "27.10.25 РІ 18:03", "@design РјРѕР¶РЅРѕ РµС‰Рµ РїСЂРѕРІРµСЂРёС‚СЊ РІРёР·СѓР°Р»СЊРЅС‹Р№ Р°РєС†РµРЅС‚ РЅР° РїРµСЂРІРѕРј РїСЂРµРґР»РѕР¶РµРЅРёРё."),
        createComment("comment-4", "maria", "27.10.25 РІ 18:03", "@release РµСЃР»Рё СЌС‚РѕС‚ С‚РµРєСЃС‚ РїРѕР№РґРµС‚ РІ РґРµРјРѕ, Р»СѓС‡С€Рµ СЃРґРµР»Р°С‚СЊ РµРіРѕ РїСЂРѕС‰Рµ РґР»СЏ РїРµСЂРІРѕРіРѕ РїРѕРєР°Р·Р°.")
      ]
    }));
  }
  if (targets[1]) {
  ...
  if (targets[2]) {
    ...
    commentThreads.set(id, createThread("thread-resolved", id, {
      ...
      comments: [
        createComment("comment-5", "maxim", "27.10.25 РІ 18:03", "Р­С‚РѕС‚ Р±Р»РѕРє СѓР¶Рµ СЃРѕРіР»Р°СЃРѕРІР°РЅ. РћСЃС‚Р°РІР»СЏРµРј С„РѕСЂРјСѓР»РёСЂРѕРІРєСѓ Рё РїРѕРјРµС‡Р°РµРј РІРµС‚РєСѓ РєР°Рє СЂРµС€РµРЅРЅСѓСЋ.", { targetPreview: getTargetPreview(targets[2]), targetType })
      ]
    }));
  }
  commentInitDone = true;
...
function formatThreadCommentsLabel(count) {
  ...
  if (mod10 === 1 && mod100 !== 11) {
    return "РџРѕРєР°Р·Р°С‚СЊ " + value + " РєРѕРјРјРµРЅС‚Р°СЂРёР№ РІРµС‚РєРё";
  }
  if (mod10 >= 2 && mod10 <= 4 && (mod100 < 12 || mod100 > 14)) {
    return "РџРѕРєР°Р·Р°С‚СЊ " + value + " РєРѕРјРјРµРЅС‚Р°СЂРёСЏ РІРµС‚РєРё";
  }
  return "РџРѕРєР°Р·Р°С‚СЊ " + value + " РєРѕРјРјРµРЅС‚Р°СЂРёРµРІ РІРµС‚РєРё";
}

function formatHistoryStatus(item) {
  if (item.deleted) {
    return "РЈРґР°Р»РµРЅР° " + formatThreadDate(item.deletedAt);
  }
  if (item.paused) {
    return "РќР° РїР°СѓР·Рµ " + formatThreadDate(item.pausedAt);
  }
  if (item.resolved) {
    return "Р РµС€РµРЅР° " + formatThreadDate(item.resolvedAt);
  }
  return "";
}
...
function renderCommentAnchors() {
  ...
  targets.forEach((target) => {
    ...
    const tooltip = count > 0 ? `РџРѕРєР°Р·Р°С‚СЊ ${count} РєРѕРјРјРµРЅС‚Р°СЂРёСЏ` : "РќР°С‡Р°С‚СЊ РѕР±СЃСѓР¶РґРµРЅРёРµ";
  ...
  if (commentSelectionDraft && commentSelectionDraft.rect) {
    ...
    html.push(
      `<div class="comment-anchor" style="top:${top}px;left:${left}px;">` +
        `<button class="comment-anchor__button is-empty is-create" data-comment-create="selection" data-comment-tooltip="РќР°С‡Р°С‚СЊ РѕР±СЃСѓР¶РґРµРЅРёРµ" type="button">` +
...
async function openDiscussionFromSelection() {
  ...
  scheduleCommentDocumentSave("Р”РѕР±Р°РІР»РµРЅРѕ РѕР±СЃСѓР¶РґРµРЅРёРµ", getCurrentCommentActor().id);
...
function renderReplyPill(thread) {
  ...
  commentsReplyText.innerHTML = `РћС‚РІРµС‚ <span class="comment-mention">@${escapeHtml(user.handle)}</span>: ${escapeHtml(comment.text).slice(0, 52)}${comment.text.length > 52 ? "вЂ¦" : ""}`;
...
function renderMentionDropdown() {
  ...
  const match = value.match(/@([A-Za-z0-9._\-\u0400-\u04FF]*)$/);
  if (!match) {
  ...
  const renderEntity = (entity, index) => {
    ...
    const meta = entity.type === "group" ? entity.meta : `${entity.role} В· ${entity.team}`;
  ...
  if (userMatches.length) {
    sections.push('<div class="comments-mentions__section">РџРѕР»СЊР·РѕРІР°С‚РµР»Рё</div>');
    sections.push(userMatches.map((user, index) => renderEntity(user, index)).join(""));
  }
  if (groupMatches.length) {
    sections.push('<div class="comments-mentions__section">Р“СЂСѓРїРїС‹</div>');
    sections.push(groupMatches.map((group, index) => renderEntity(group, userMatches.length + index)).join(""));
  }

  commentsMentionDropdown.innerHTML = sections.join("") + '<div class="comments-mentions__more">РњРѕР¶РЅРѕ СѓРїРѕРјРёРЅР°С‚СЊ Р»СЋРґРµР№ Рё РєРѕРјР°РЅРґС‹ РїСЂРѕРµРєС‚Р°</div>';
...
function applyMention(userId) {
  ...
  commentsComposerInput.value = commentsComposerInput.value.replace(/@([A-Za-z0-9._\-\u0400-\u04FF]*)$/, `@${entity.handle} `);
  commentsMentionDropdown.classList.remove("is-open");
  commentsMentionDropdown.innerHTML = "";
  commentsComposerInput.focus();
  updateComposerState();
      ...
      <div class="comment-card__body">
        <div class="comment-card__top">
          <div>
            ...
            <div class="comment-card__meta-line">
              ...
              <span class="comment-card__role">${escapeHtml(user.role || user.team || "РЈС‡Р°СЃС‚РЅРёРє")}</span>
            </div>
          </div>
          <div class="comment-card__actions">
            <button class="comment-action${isLiked ? " is-active" : ""}" data-comment-action="like" data-comment-id="${comment.id}" type="button" aria-label="РќСЂР°РІРёС‚СЃСЏ" data-comment-tooltip="${isLiked ? "РЈР±СЂР°С‚СЊ Р»Р°Р№Рє" : "РќСЂР°РІРёС‚СЃСЏ"}">
              ${thumbsUpSvg()}
              ${likeCount ? `<span class="comment-action__count">${likeCount}</span>` : ""}
            </button>
            <button class="comment-action" data-comment-action="reply" data-comment-id="${comment.id}" type="button" aria-label="РћС‚РІРµС‚РёС‚СЊ" data-comment-tooltip="РћС‚РІРµС‚РёС‚СЊ">
              ${replySvg()}
            </button>
            <div class="comment-card__menu-wrap"${canOpenMenu ? "" : " hidden"}>
              <button class="comment-action" data-comment-action="menu" data-comment-id="${comment.id}" type="button" aria-label="Р”РµР№СЃС‚РІРёСЏ" data-comment-tooltip="Р”РµР№СЃС‚РІРёСЏ">
                ${menuSvg()}
              </button>
              <div class="comment-card__menu${menuOpen ? " is-open" : ""}">
                ${canEdit ? `<button class="comment-card__menu-item" data-comment-action="edit" data-comment-id="${comment.id}" type="button">Р РµРґР°РєС‚РёСЂРѕРІР°С‚СЊ</button>` : ""}
                ${canDelete ? `<button class="comment-card__menu-item is-danger" data-comment-action="delete" data-comment-id="${comment.id}" type="button">РЈРґР°Р»РёС‚СЊ</button>` : ""}
              </div>
            </div>
          </div>
        </div>
        ...
        ${isEditing ? `
          <div class="comment-card__editor">
            ...
            <button class="comment-card__save" data-comment-action="save-edit" data-comment-id="${comment.id}" type="button">РЎРѕС…СЂР°РЅРёС‚СЊ</button>
          </div>
...
function renderCommentsPanel() {
  ...
  if (!isOpen) {
    ...
    commentsPanelContext.textContent = "РќРµС‚ РІС‹Р±СЂР°РЅРЅРѕРіРѕ Р±Р»РѕРєР°";
  ...
  commentsPanelStatus.textContent = thread.status === "resolved" ? "Р РµС€РµРЅР°" : (thread.status === "paused" ? "РќР° РїР°СѓР·Рµ" : "");
  if (commentsPauseButton) {
    commentsPauseButton.dataset.commentTooltip = thread.status === "paused" ? "РџСЂРѕРґРѕР»Р¶РёС‚СЊ РѕР±СЃСѓР¶РґРµРЅРёРµ" : "РџСЂРёРѕСЃС‚Р°РЅРѕРІРёС‚СЊ РѕР±СЃСѓР¶РґРµРЅРёРµ";
  ...
  if (commentsComposerInput) {
    ...
    commentsComposerInput.placeholder = paused ? "РћР±СЃСѓР¶РґРµРЅРёРµ РїСЂРёРѕСЃС‚Р°РЅРѕРІР»РµРЅРѕ" : "РќРѕРІС‹Р№ РєРѕРјРјРµРЅС‚Р°СЂРёР№";
  }
...
async function toggleResolvedThread() {
  ...
  if (commentPageId) {
    ...
    await createCommentVersion(
      nextResolved ? "РћР±СЃСѓР¶РґРµРЅРёРµ РѕС‚РјРµС‡РµРЅРѕ РєР°Рє СЂРµС€РµРЅРЅРѕРµ" : "РћР±СЃР¶РґРµРЅРёРµ РІРѕР·РІСЂР°С‰РµРЅРѕ РІ СЂР°Р±РѕС‚Сѓ",
      getCurrentCommentActor().id
    );
  } else {
    thread.status = nextResolved ? "resolved" : "open";
    if (thread.status === "resolved") {
      addHistorySnapshot(thread, "Р РµС€РµРЅР° " + formatThreadDate(new Date().toISOString()));
    }
  }
  renderCommentsPanel();
  scheduleCommentAnchors();
...
async function togglePausedThread() {
  ...
  if (commentPageId) {
    ...
    await syncThreadsFromServer(true);
    await createCommentVersion(
      nextPaused ? "РћР±СЃСѓР¶РґРµРЅРёРµ РїРѕСЃС‚Р°РІР»РµРЅРѕ РЅР° РїР°СѓР·Сѓ" : "РћР±СЃСѓР¶РґРµРЅРёРµ РІРѕР·РѕР±РЅРѕРІР»РµРЅРѕ",
      getCurrentCommentActor().id
    );
  } else {
    thread.status = nextPaused ? "paused" : "open";
    if (thread.status === "paused") {
      addHistorySnapshot(thread, "РќР° РїР°СѓР·Рµ " + formatThreadDate(new Date().toISOString()));
    }
  }
  renderCommentsPanel();
  scheduleCommentAnchors();
...
async function addCommentToThread() {
  ...
  const versionLabel = isNewDiscussion
    ? "Р”РѕР±Р°РІР»РµРЅРѕ РѕР±СЃСѓР¶РґРµРЅРёРµ"
    : (commentReplyTo ? "Р”РѕР±Р°РІР»РµРЅ РѕС‚РІРµС‚ РІ РѕР±СЃСѓР¶РґРµРЅРёРё" : "Р”РѕР±Р°РІР»РµРЅ РєРѕРјРјРµРЅС‚Р°СЂРёР№ РІ РѕР±СЃСѓР¶РґРµРЅРёРё");
  let text = raw;
  ...
  updateComposerState();
  const now = new Date();
  const dateLabel = now.toLocaleDateString("ru-RU") + " РІ " + now.toLocaleTimeString("ru-RU", { hour: "2-digit", minute: "2-digit" });
...
function renderHistoryModal() {
    ...
    commentsHistoryBody.innerHTML = `
      <div class="comments-history-modal__error">
        <div class="comments-history-modal__error-inner">
          <div>РќРµ СѓРґР°Р»РѕСЃСЊ Р·Р°РіСЂСѓР·РёС‚СЊ РєРѕРјРјРµРЅС‚Р°СЂРёРё.<br>РџРѕРїСЂРѕР±СѓР№С‚Рµ РµС‰Рµ СЂР°Р·</div>
          <button class="comments-panel__retry" data-history-action="retry" type="button">Р—Р°РіСЂСѓР·РёС‚СЊ РїРѕРІС‚РѕСЂРЅРѕ</button>
        </div>
      </div>
    `;
  ...
  if (!filteredItems.length) {
    const emptyMessage = commentHistorySelectedThreadId
      ? "Р”Р»СЏ РІС‹Р±СЂР°РЅРЅРѕРіРѕ РѕР±СЃСѓР¶РґРµРЅРёСЏ РїРѕРєР° РЅРµС‚ РёСЃС‚РѕСЂРёРё"
      : "РСЃС‚РѕСЂРёСЏ РєРѕРјРјРµРЅС‚Р°СЂРёРµРІ РїРѕРєР° РїСѓСЃС‚Р°";
  ...
  commentsHistoryBody.innerHTML = pageItems.map((item) => {
    ...
    const attachment = item.thumb
      ? `<div class="comments-history-item__thumb"><div class="comments-history-item__thumb-image"></div><div class="comments-history-item__thumb-label">${escapeHtml(item.attachmentLabel || "РР·РѕР±СЂР°Р¶РµРЅРёРµ")}</div></div>`
      : "";
    ...
    return `
      <article class="comments-history-item" data-history-id="${item.id}">
        ...
        ${actions}
        ${hasReplies ? `<button class="comments-history-item__toggle" data-history-action="toggle-thread" data-history-id="${item.id}" type="button">${expanded ? "РЎРєСЂС‹С‚СЊ РІРµС‚РєСѓ" : escapeHtml(item.toggleLabel || formatThreadCommentsLabel(replies.length))}</button>` : ""}
        ${nested}
      </article>
    `;
  }).join("");
...
function initializeCommentsSystem() {
  ...
  if (authUser && authUser.id) {
    setCurrentCommentActor(authUser.id, false);
  }
  ...
  if (docHeaderSubtitle) {
    ...
    docHeaderSubtitle.addEventListener("input", () => {
      ...
      scheduleCommentDocumentSave("РР·РјРµРЅРµРЅРѕ РѕРїРёСЃР°РЅРёРµ", getCurrentCommentActor().id);
    });
    ...
    if (action === "like" && comment) {
      ...
      if (commentPageId) {
        ...
        .then(() => {
          renderCommentsPanel();
          scheduleCommentAnchors();
          createCommentVersion("РР·РјРµРЅРµРЅР° СЂРµР°РєС†РёСЏ РІ РѕР±СЃСѓР¶РґРµРЅРёРё", getCurrentCommentActor().id).catch((error) => console.warn("Failed to create like version", error));
        }).catch((error) => {
      ...
      request.then(() => {
        if (commentPageId) {
          ...
          createCommentVersion(
            isRootMessage ? "РЈРґР°Р»РµРЅРѕ РѕР±СЃСѓР¶РґРµРЅРёРµ" : "РЈРґР°Р»РµРЅ РєРѕРјРјРµРЅС‚Р°СЂРёР№",
            getCurrentCommentActor().id
    ...
    if (action === "save-edit" && comment) {
      ...
      request.then(() => {
        if (commentPageId) {
          ...
          createCommentVersion("РР·РјРµРЅРµРЅ РєРѕРјРјРµРЅС‚Р°СЂРёР№", getCurrentCommentActor().id)
  ...
  bodyEditor.addEventListener("input", () => scheduleCommentDocumentSave("РР·РјРµРЅРµРЅРёРµ С‚РµРєСЃС‚Р°", getCurrentCommentActor().id));
  titleEditor.addEventListener("input", () => scheduleCommentDocumentSave("РР·РјРµРЅРµРЅ Р·Р°РіРѕР»РѕРІРѕРє", getCurrentCommentActor().id));
  titleEditor.addEventListener("keyup", () => scheduleCommentDocumentSave("РР·РјРµРЅРµРЅ Р·Р°РіРѕР»РѕРІРѕРє", getCurrentCommentActor().id));
    ...
    input.addEventListener("change", async () => {
      ...
      if (commentPageId) {
        try {
          ...
          await createCommentVersion("РР·РјРµРЅРµРЅ РґРѕСЃС‚СѓРї Рє РєРѕРјРјРµРЅС‚Р°СЂРёСЏРј", getCurrentCommentActor().id);
        } catch (error) {
